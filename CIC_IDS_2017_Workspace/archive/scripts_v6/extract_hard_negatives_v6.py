...
def main():
    ...
    df_full['Label_Stage2_V7'] = df_full['Label'].apply(map_stage2_v6)
    ...
    cols_to_drop = ['Label', 'Label_Stage1', 'Label_Stage2', 'Label_Stage2_V6']
    ...
    out_path = 'processed_data/cic_train_stage2_v6_hard.csv'
