...
DATA_DIR = "/home/ning/Graduation-Thesis/CIC-IDS- 2017_dataset"
OUTPUT_DIR = "/home/ning/Graduation-Thesis/CIC_Processed_Chunks"
...
def main():
    ...
    if not csv_files:
        print(f"Không tìm thấy file CSV nào tại {DATA_DIR}")
        return
    ...
    train_size = min(500000, int(len(full_df) * 0.8))
