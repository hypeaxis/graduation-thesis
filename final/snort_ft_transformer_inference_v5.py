...
DEFAULT_FT_CHECKPOINT = PROJECT_ROOT / 'final' / 'model_packages' / 'two_stage_v5' / 'best_model.pt'
DEFAULT_AE_CHECKPOINT = PROJECT_ROOT / 'final' / 'model_packages' / 'two_stage_v5' / 'autoencoder_v2_best.h5'
DEFAULT_INFERENCE_CONFIG = PROJECT_ROOT / 'final' / 'model_packages' / 'two_stage_v5' / 'inference_config.json'
DEFAULT_SCALER = PROJECT_ROOT / 'final' / 'model_packages' / 'two_stage_v5' / 'scaler.pkl'
