"""
v8_3_train_huong2.py — V8.3 Hướng 2: Fine-tune V7 model với CIC PortScan injected data
Dựa trên 4e_retrain_run7_v7.py, thay đổi:
  - Data: Combined_V8_3_Huong2.csv (run10 Benign/BF/WebAtk/DoS + CIC PortScan 5k)
...
# PATHS
# ============================================================================
DATA_PATH       = os.path.join(WORKSPACE_DIR, 'Combined_V8_3_Huong2.csv')
...
MODEL_SAVE_PATH   = os.path.join(WORKSPACE_DIR, 'v8_3_huong2_model.pt')
SCALER_SAVE_PATH  = os.path.join(WORKSPACE_DIR, 'v8_3_huong2_scaler.pkl')
ENCODER_SAVE_PATH = os.path.join(WORKSPACE_DIR, 'v8_3_huong2_encoder.pkl')
...
def main():
    print("=" * 60)
    print("V8.3 HƯỚNG 2: Fine-tune V7 + CIC PortScan Injection")
    print("=" * 60)
