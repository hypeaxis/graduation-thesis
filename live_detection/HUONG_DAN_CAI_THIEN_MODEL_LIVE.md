...
| 4 | **retrain robust-log (negative control)** | **24.68% → 73.87%** ❌ (DoS-FP 20.8%→38.9%) | — | **0.9193** (CIC val) | Port 91/DoS 21/BF 99.6/WA 85% | Chẩn đoán: clip 0.2%, RF AUROC 1.0, benign-FP median 27 gói. Retrain robust-log **làm FP TỆ HẲN** → phủ định dứt khoát giả thuyết tiền xử lý. Giữ V8.5, v8_6 chỉ làm chứng cứ. **→ Bước 5.** Chi tiết: [BUOC4_KETQUA.md](training/BUOC4_KETQUA.md) |
