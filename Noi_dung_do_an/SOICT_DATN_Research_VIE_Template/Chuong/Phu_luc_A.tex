...
\begin{lstlisting}[language=Python, caption={Load flow CSV và apply PowerTransformer của FT-IDS}]
import pandas as pd
from sklearn.preprocessing import PowerTransformer
import joblib

# Load scaler da train tren Testbed (FT-IDS)
...
echo "IDS Pipeline started. Snort + FT-IDS active."
\end{lstlisting}
