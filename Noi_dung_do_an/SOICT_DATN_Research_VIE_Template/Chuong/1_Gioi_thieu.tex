...
\begin{enumerate}
    ...
    \item \textbf{Hệ thống Hybrid IDS phát hiện theo phát lại trên phần cứng phổ thông:} Hệ thống tích hợp Snort 3 và FT-Transformer V8.5 trên WSL2 Ubuntu, không yêu cầu GPU, được hiện thực hóa ở dạng phát hiện theo phát lại với giao diện thời gian thực. Thực nghiệm xác nhận tính bổ sung hai tầng: DoS slowhttptest chỉ phát hiện được bởi ML, XSS payload ngắn chỉ phát hiện được bởi Snort. Một luật hậu xử lý kiểu dấu hiệu (đếm cổng đích theo nguồn) bù cho đặc trưng quét cổng mà mô hình thiếu, nâng PortScan F1 từ 0,000 lên 0,996 mà không cần huấn luyện lại. Đường xử lý thời gian thực hoàn toàn được đề xuất như một hướng phát triển.
\end{enumerate}
