...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        default="/home/ning/Graduation-Thesis/final/log/alert.csv",
        help="Path to Snort alert CSV generated by final/snort.conf.",
    )
    parser.add_argument(
        "--feature-columns",
        default="/home/ning/Graduation-Thesis/MLAnomalyDetection/artifacts_preprocess/feature_columns.json",
        help="Path to feature_columns.json.",
    )
    parser.add_argument(
        "--scaler",
        default="/home/ning/Graduation-Thesis/MLAnomalyDetection/artifacts_preprocess/scaler.pkl",
        help="Path to scaler.pkl fit from train pipeline.",
    )
    parser.add_argument(
        "--output",
        default="/home/ning/Graduation-Thesis/final/snort_features_122.csv",
        help="Output CSV path for model-ready vectors.",
    )
    parser.add_argument(
        "--window-seconds",
        type=float,
