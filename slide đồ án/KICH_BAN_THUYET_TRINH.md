...
## Đề tài: Hệ thống phát hiện xâm nhập mạng lai ghép (Snort + FT-Transformer)
...
> "Kính chào Hội đồng. Em xin trình bày đồ án tốt nghiệp: **Hệ thống phát hiện xâm nhập mạng lai ghép kết hợp Snort và FT-Transformer**. Em là *[họ tên]*, dưới sự hướng dẫn của *[thầy/cô]*."
...
> "**Giai đoạn 1** thiết lập kiến trúc nền tảng trên NSL-KDD. Kiến trúc gồm **hai tầng**: một **Autoencoder Anomaly Gate** học không gian lưu lượng bình thường để lọc Benign — ưu điểm là **không cần nhãn tấn công**; sau đó một **Stacking Ensemble** kết hợp FT-Transformer với LightGBM qua một Meta Logistic Regression để phân loại tấn công.
>
...
- [ ] Tập trả lời trơn 9 câu Q&A ở trên.
