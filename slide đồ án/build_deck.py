...
para(tf, "PHÁT TRIỂN HỆ THỐNG PHÁT HIỆN TẤN CÔNG MẠNG", 26, True, WHITE, align=PP_ALIGN.CENTER, first=True, after=2)
para(tf, "bằng phát hiện bất thường", 20, False, RGBColor(0xC9,0xD4,0xE6), align=PP_ALIGN.CENTER)
tf = box(s, 1.0, 5.15, 8.0, 1.6)
para(tf, "Sinh viên thực hiện:  Đỗ Tuấn Minh — MSSV 20225741", 14, False, WHITE, align=PP_ALIGN.CENTER, first=True, after=3)
para(tf, "Lớp Việt Nhật 07  ·  Trường Công nghệ Thông tin và Truyền thông", 14, False, WHITE, align=PP_ALIGN.CENTER, after=3)
para(tf, "Giảng viên hướng dẫn:  PGS.TS. Nguyễn Linh Giang", 14, False, WHITE, align=PP_ALIGN.CENTER, after=3)
...
para(tf, "cách tiếp cận: phát hiện bất thường → định danh loại tấn công", 13, False, NAVY, bullet=True)
...
para(tf, "Autoencoder Anomaly Gate = phát hiện bất thường: học Benign, cái gì lệch là bất thường (không cần nhãn tấn công)", 12.5, False, TEXT, bullet=True)
...
para(tf, "Đỗ Tuấn Minh — [email/liên hệ]", 14, False, WHITE, align=PP_ALIGN.CENTER, first=True)
