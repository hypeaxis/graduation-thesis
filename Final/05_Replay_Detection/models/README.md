...
Đường dẫn được khai báo trong `../replay_config.json` (tương đối so với `Final/`). Không cần chỉnh nếu chạy `uvicorn server:app` từ thư mục `05_Replay_Detection/`.

Train lại: xem `../../03_Testbed_Retrain/HUONG_DAN_CHAY.md`.
