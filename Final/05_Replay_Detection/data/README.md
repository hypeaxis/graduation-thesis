...
Quy trình thu chi tiết: [../../03_Testbed_Retrain/HUONG_DAN_THU_DU_LIEU.md](../../03_Testbed_Retrain/HUONG_DAN_THU_DU_LIEU.md).

Sau khi có file, đặt vào thư mục này — `replay_config.json` đã trỏ sẵn đường dẫn `05_Replay_Detection/data/<file>`.
