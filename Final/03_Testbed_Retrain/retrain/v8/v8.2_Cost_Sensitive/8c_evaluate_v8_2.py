...
def main():
    print("="*60)
    print("V8.2. ĐÁNH GIÁ CHÍNH THỨC (COST-SENSITIVE LEARNING)")
    print("="*60)

    DATA_TEST_PATH = '../../data/run7_test.csv'
    MODEL_PATH = 'v8_2_model.pt'
    ENCODER_PATH = 'v8_2_encoder.pkl'
    PIPELINE_PATH = 'v8_2_hybrid_pipeline.pkl'
